"""
Django settings for Stygmergy project.
...
SECRET_KEY = 'dfsrjeh@now%$98_629moo2c#g7ni6*5j$my9n2a$0e+mg!ohn'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['backend','172.24.98.145', '172.24.98.144', '172.24.98.143', '172.24.98.142','localhost', '3.86.244.74']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates'),
                 ...
                 os.path.join(BASE_DIR,'restaurante/templates/restaurante')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Stygmergy.wsgi.application'
